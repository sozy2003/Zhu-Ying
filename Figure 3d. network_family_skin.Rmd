---
title: "co-occurrence network in skin samples"
author: "Zhu Ying"
date: "2023-06-14"
...
output_prefix = "net_family_skin_"
...
design_sub <- design[design$group=="skin",]
...
p <- plot(g,vertex.label.dist=0.7)
print(p)
```
...
save( arc_skin, node_skin,g_skin,p_skin,file=paste0(output_prefix, ".Rdata"))
```
